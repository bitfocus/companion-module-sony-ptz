...
export function UpdatePresets(self: ModuleInstance): void {
	const PRESET_LIST: PresetSpec[] = [
		...
		['White Balance', 'Auto', 'White Balance\\nAuto', 'whitebalancemode_auto', [], []],
		['White Balance', 'Indoor', 'White Balance\\nIndoor', 'whitebalancemode_indoor', [], []],
		['White Balance', 'Outdoor', 'White Balance\\nOutdoor', 'whitebalancemode_outdoor', [], []],
		['White Balance', 'One Push WB', 'White Balance\\nOne Push WB', 'whitebalancemode_onepushwb', [], []],
		['White Balance', 'ATW', 'White Balance\\nATW', 'whitebalancemode_atw', [], []],
		['White Balance', 'Manual', 'White Balance\\nManual', 'whitebalancemode_manual', [], []],
		['Stabilizer', 'On', 'Stabilizer\\nOn', 'stabilizer_on', [], []],
		['Stabilizer', 'Off', 'Stabilizer\\nOff', 'stabilizer_off', [], []],
		['Tally Control', 'On', 'Tally Control\\nOn', 'tallycontrol_on', [], []],
		['Tally Control', 'Off', 'Tally Control\\nOff', 'tallycontrol_off', [], []],
		[
			'Auto Framing',
			'Home',
			'Auto Framing\\nHome',
